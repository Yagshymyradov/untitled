...
/// [SearchDelegateCustom.close] call. If the search page is closed with the system
/// back button, it returns null.
///
/// A given [SearchDelegateCustom] can only be associated with one active [showCustomSearch]
/// call. Call [SearchDelegateCustom.close] before re-using the same delegate instance
...
/// The animation provided by [SearchDelegateCustom.transitionAnimation] can be used
...
/// See also:
///
///  * [SearchDelegateCustom] to define the content of the search page.
...
/// query text field can be customized via [SearchDelegateCustom.buildLeading]
/// and [SearchDelegateCustom.buildActions]. Additionally, a widget can be placed
/// across the bottom of the [AppBar] via [SearchDelegateCustom.buildBottom].
///
/// The body below the [AppBar] can either show suggested queries (returned by
/// [SearchDelegateCustom.buildSuggestions]) or - once the user submits a search  - the
/// results of the search as returned by [SearchDelegateCustom.buildResults].
///
/// [SearchDelegateCustom.query] always contains the current query entered by the user
/// and should be used to build the suggestions and results.
///
/// The results can be brought on screen by calling [SearchDelegateCustom.showResults]
/// and you can go back to showing the suggestions by calling
/// [SearchDelegateCustom.showSuggestions].
///
/// Once the user has selected a search result, [SearchDelegateCustom.close] should be
...
abstract class SearchDelegateCustom<T> {
  ...
  /// {@tool snippet}
  /// ```dart
  /// class CustomSearchHintDelegate extends SearchDelegateCustom<String> {
...
enum _SearchBody {
  ...
  ///
  /// The suggested queries are generated by [SearchDelegateCustom.buildSuggestions].
  suggestions,

  /// Search results are currently shown in the body.
  ///
  /// The search results are generated by [SearchDelegateCustom.buildResults].
  results,
}
              ...
              title: Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    suffixIcon: widget.delegate.searchFieldSuffixIcon(context),
